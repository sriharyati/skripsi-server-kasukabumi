...
seeder.connect('mongodb://sriharyati:sriskripsi@cluster0-shard-00-00.0wghs.mongodb.net:27017,cluster0-shard-00-01.0wghs.mongodb.net:27017,cluster0-shard-00-02.0wghs.mongodb.net:27017/db_kasukabumi?ssl=true&replicaSet=atlas-14a6dy-shard-0&authSource=admin&retryWrites=true&w=majority', {
  ...
  seeder.clearModels(['Category', 'Bank', 'Item', 'Member', 'Item', 'Feature', 'Image', 'Booking', 'Users', 'Testimonial'], function () {
...
var data = [
  ...
  // member
  {
    ...
    'documents': [
      ...
      },
      {
        ...
        firstName: 'Yein',
        lastName: 'Narayana',
        email: 'srisanjaya1207@gmail.com',
        phoneNumber: '082377954008'
      }
    ]
  },
  ...
  },
  {
    ...
    'documents': [
      {
        _id: mongoose.Types.ObjectId('5e96cbe292b97300fc903355'),
        photoTestimonial: 'images/testimonial2.jpg',
        name: 'Liburan yang menyenangkan',
        rate: '4',
        content: 'What a great trip with my family and I should try again next time soon',
        familyName: 'Sri Haryati',
        familyOccupation: 'Pegawai',
      },
    ]
  }
];